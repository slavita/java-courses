...
public class Runner {
    ...
    private void addTestClients() {
        clinic.addClient(new Client("Вася", new Cat("Пушок")));
        clinic.addClient(new Client("Петя", new Cat("Рыжик")));
        clinic.addClient(new Client("Настя", new Dog("Шарик")));
        clinic.addClient(new Client("Иван", new Cat("Мурзик")));
    }
    ...
    private void addNewClientAction() {
        ...
        Pet pet = requestNewPet();
        this.clinic.addClient(new Client(clientId, pet));
